    ...
    <div id="main_container">
        <section class="b_inner">
            <div class="hori_cont">
                ...
                <div class="detail">
	                <c:choose>
	                	<c:when test="${mDto.member_id == user.username }">
		                    <div class="top">
	                	...
	                	<c:otherwise>
	                		<div class="top">
		                        ...
		                        <a href="/member/follow?member_id=${user.username}" class="profile_edit" style="font-size: 15px;"><img src="/resources/image/following.png" style="width: 20px;"></a>
